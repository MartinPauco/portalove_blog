<?php
      ...
      if (isset($_POST['edit_user']))
      {
        ...
        $sql_edit_user = "UPDATE users SET name='$edit_user_name', username='$edit_user_username', email='$edit_user_email', password='$edit_user_password', gender = '$edit_user_gender', image = '$add_user_image', status='$edit_user_status', type='$edit_user_type' WHERE id={$edit_user_id}";
