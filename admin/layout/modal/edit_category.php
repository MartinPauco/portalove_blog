<?php
      ...
      if (isset($_POST['edit_category']))
      {
        ...
        $sql_edit_category = "UPDATE categories SET cat_title='$edit_cat_title', cat_desc='$edit_cat_desc',cat_date='$edit_cat_date',cat_edit_date='$current_date', cat_status='$edit_cat_status',cat_priority='$edit_cat_priority'  WHERE id={$edit_cat_id}";
